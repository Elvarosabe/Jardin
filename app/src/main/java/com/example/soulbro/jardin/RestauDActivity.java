...
public class RestauDActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restau_d);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.restau_d, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            intent = new Intent(RestauDActivity.this,MainDActivity.class);
        ...
        {
            intent = new Intent(RestauDActivity.this,HotelDActivity.class);
            intent.putExtra("username",username); //envio mi nombre de usuario a PerfilActivity
            intent.putExtra("correo",correo);
            startActivity(intent);
        ...
        {
            intent = new Intent(RestauDActivity.this,SitiosDActivity.class);
            intent.putExtra("username",username); //envio mi nombre de usuario a PerfilActivity
            intent.putExtra("correo",correo);
            startActivity(intent);
        } else if (id == R.id.nav_manage) {
            intent = new Intent(RestauDActivity.this, LoginActivity.class);
            startActivity(intent);
        }
